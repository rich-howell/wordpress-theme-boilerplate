...
(function (root, factory) {
  ...
  Lightbox.prototype.init = function() {
    var self = this;
    // Both enable and build methods require the body $post_tag to be in the DOM.
  ...
  Lightbox.prototype.sizeOverlay = function() {
    ...
    $post_tag that disables scrolling and hides the scrollbar. We want to make sure the scrollbar is
